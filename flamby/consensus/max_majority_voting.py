...
def max_voting_combiner(task, preds_concs):
    if task == "segmentation":
        return max_voting_segmentation(preds_concs)
    else:
        return max_voting_classification(preds_concs)


def max_voting_classification(preds_concs):
...
def max_voting_segmentation(preds_concs):
